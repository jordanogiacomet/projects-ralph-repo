  ...
  return (
    <div className={cn('grid gap-2', wrapperClassName)}>
      ...
      <textarea
        ...
        className={cn(
          'motion-transition min-h-32 w-full resize-y rounded-field border border-border bg-surface-primary px-4 py-3 text-sm text-text-primary shadow-[inset_0_1px_0_rgba(255,255,255,0.5)] placeholder:text-text-muted hover:border-border-strong hover:bg-white focus:border-accent/40 focus:outline-none focus:ring-4 focus:ring-accent/10 disabled:cursor-not-allowed disabled:bg-surface-secondary disabled:text-text-muted',
