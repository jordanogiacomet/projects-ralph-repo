  ...
  return (
    <div className={cn('grid gap-2', wrapperClassName)}>
      ...
      <input
        ...
        className={cn(
          'motion-transition w-full rounded-field border border-border bg-surface-primary px-4 py-3 text-sm text-text-primary shadow-[inset_0_1px_0_rgba(255,255,255,0.5)] placeholder:text-text-muted focus:border-accent/40 focus:outline-none focus:ring-4 focus:ring-accent/10',
