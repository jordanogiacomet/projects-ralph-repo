...
const solutionSlug = 'revisao-da-vida-util'
      ...
      children: [
        {
          type: 'heading',
          tag: 'h2',
          children: [{ type: 'text', text: 'Depreciação aderente à realidade operacional e ao CPC 27' }],
        },
        {
          type: 'paragraph',
          children: [
...
export default async function RevisaoDaVidaUtilPage() {
  const data = await getSolutionPageData()
