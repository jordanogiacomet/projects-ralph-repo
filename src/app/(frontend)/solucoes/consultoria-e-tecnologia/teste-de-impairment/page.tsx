...
const solutionSlug = 'teste-de-impairment'
      ...
      children: [
        {
          type: 'heading',
          tag: 'h2',
          children: [{ type: 'text', text: 'Avaliação técnica de recuperabilidade com base normativa' }],
        },
        {
          type: 'paragraph',
          children: [
...
export default async function TesteDeImpairmentPage() {
  const data = await getSolutionPageData()
