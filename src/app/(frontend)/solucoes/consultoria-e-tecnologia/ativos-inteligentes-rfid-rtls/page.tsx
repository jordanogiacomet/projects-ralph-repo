...
const solutionSlug = 'ativos-inteligentes-rfid-rtls'
const legacySolutionSlug = 'ativos-inteligentes-rfid-e-rtls'
...
export default async function AtivosInteligentesRfidRtlsPage() {
  const data = await getSolutionPageData()
