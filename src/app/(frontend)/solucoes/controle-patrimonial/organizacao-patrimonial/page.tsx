...
const solutionSlug = 'organizacao-patrimonial'
      ...
      children: [
        {
          type: 'heading',
          tag: 'h2',
          children: [{ type: 'text', text: 'Estruturação da base patrimonial com metodologia técnica' }],
        },
        {
          type: 'paragraph',
          children: [
...
export default async function OrganizacaoPatrimonialPage() {
  const data = await getSolutionPageData()
