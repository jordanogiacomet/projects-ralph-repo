...
const solutionSlug = 'etiquetas-patrimoniais-inteligentes'
      ...
      children: [
        {
          type: 'heading',
          tag: 'h2',
          children: [{ type: 'text', text: 'Identificação patrimonial com padrão técnico e alta durabilidade' }],
        },
        {
          type: 'paragraph',
          children: [
...
export default async function EtiquetasPatrimoniaisInteligentesPage() {
  const data = await getSolutionPageData()
